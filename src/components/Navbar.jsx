        ...
        >
          <ul className="navbar-nav align-items-xl-center gap-xl-2 ms-auto">
            <li className="nav-item">
              <a
                className={`nav-link ${
                  activeMobileLink === "#hero" ? "is-active-mobile" : ""
                }`}
                href="#hero"
            ...
            <li className="nav-item">
              <a
                className={`nav-link ${
                  activeMobileLink === "#about" ? "is-active-mobile" : ""
                }`}
                href="#about"
            ...
            <li className="nav-item">
              <a
                className={`nav-link ${
                  activeMobileLink === "#help" ? "is-active-mobile" : ""
                }`}
                href="#help"
            ...
            <li className="nav-item">
              <a
                className={`nav-link ${
                  activeMobileLink === "#therapy-services" ? "is-active-mobile" : ""
                }`}
            ...
            <li className="nav-item">
              <a
                className={`nav-link ${
                  activeMobileLink === "#testimonials" ? "is-active-mobile" : ""
                }`}
                href="#testimonials"
            ...
            <li className="nav-item">
              <a
                className={`nav-link ${
                  activeMobileLink === "#contact" ? "is-active-mobile" : ""
                }`}
                href="#contact"
